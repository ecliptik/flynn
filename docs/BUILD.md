...
### full (~1024KB partition, ~158KB binary) — DEFAULT
...
When enabled, 9 built-in color themes are available (Solarized Light/Dark, TokyoNight
Day/Night, Amber CRT, System 7, Compact Mac, Dracula, Nord) plus Light and Dark mono
themes, and import/export of Ghostty-format theme files. Imported
...
Build complete (v1.10.0, full preset):
  ...
  SIZE: 1024KB preferred / 960KB minimum
```
